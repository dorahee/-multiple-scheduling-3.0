...
penalty_weight_range = [1, 10]
num_tasks_dependent_range = [0, 3, 6]
            ...
            for penalty_weight in penalty_weight_range:
                ...
                for num_tasks_dependent in num_tasks_dependent_range:
                    ...
                    print(f"{num_households} households, "
                          ...
                          f"{num_full_flex_tasks_min} fully flexible tasks, "
                    ...
                    for alg in algorithms.values():
                        ...
                        start_time_probability = new_iteration.begin_iteration(starting_prices=prices, num_cpus=num_vcpu)
